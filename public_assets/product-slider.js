    ...
    !(function (e) {
      ...
      (e.cleanData = (function (t) {
        ...
        (e.widget = function (t, i, s) {
          ...
          return (
            ...
            (a.prototype = e.widget.extend(
              ...
              h,
              { constructor: a, namespace: u, widgetName: t, widgetFullName: r }
            )),
            n
        ...
        (e.widget.extend = function (t) {
          for (
            var s, n, a = i.call(arguments, 1), o = 0, h = a.length;
            h > o;
            o++
          )
            for (s in a[o])
                      ...
                      return "instance" === a
                        ...
                        ? e.isFunction(s[a]) && "_" !== a.charAt(0)
                          ? (i = s[a].apply(s, h)) !== s && void 0 !== i
                            ? ((u = i && i.jquery ? u.pushStack(i.get()) : i),
                              !1)
                            : void 0
                          : e.error(
                              "no such method '" +
            ...
            this._hasMultipleValues()
              ? this.handles.each(function (s) {
                  (i =
                    ...
                    100),
                    (l["horizontal" === u.orientation ? "left" : "bottom"] =
                      i + "%"),
                    e(this).stop(1, 1)[r ? "animate" : "css"](l, h.animate),
                    !0 === u.options.range &&
              ...
              : ((s = this.value()),
                ...
                (l["horizontal" === this.orientation ? "left" : "bottom"] =
                  i + "%"),
                this.handle.stop(1, 1)[r ? "animate" : "css"](l, h.animate),
                "min" === o &&
                  "horizontal" === this.orientation &&
                  this.range
                    .stop(1, 1)
                    [r ? "animate" : "css"]({ width: i + "%" }, h.animate),
                "max" === o &&
                  "horizontal" === this.orientation &&
                  this.range
                    .stop(1, 1)
                ...
                "min" === o &&
                  ...
                  this.range
                    .stop(1, 1)
                    [r ? "animate" : "css"]({ height: i + "%" }, h.animate),
                "max" === o &&
                  "vertical" === this.orientation &&
                  this.range
                    .stop(1, 1)
        ...
        (b.Isotope.prototype = {
          ...
          _cellsByColumnGetContainerSize: function () {
            return {
              width:
                Math.ceil(
                  this.$filteredAtoms.length / this.cellsByColumn.rows
        ...
        function d(a, b) {
          ...
          g(a, h),
            b.on("click", function (e) {
              c.toggle
                ? (i
                    ? (g(a, d), (this.text = c.text[0]))
                    : (g(a, h), (this.text = c.text[1])),
                  (i = !i))
                : (g(a, d), b.hide()),
                e.preventDefault();
            });
            ...
            b.each(function () {
              ...
              (e += g),
                e <= c.limit
                  ? d.push(b)
                  : ((f = c.limit - (e - g)),
                    f > 0 ? d.push(b.slice(0, f) + c.ellipsis) : d.push(""));
            }),
            d
          );
        }
              ...
              h.forEach(function (t) {
                ...
                try {
                  ...
                  return void (
                    o &&
                    o.error(
                      "Error parsing " + s + " on " + t.className + ": " + l
                    )
                  );
                }
                var a = new e(t, i);
...
`;
  ...
  var initTestimonialForm = function ($) {
    var config_form = "";
    $("body")
      .find("div[id*='simesy-testimonial-form']")
      .each(function (i, v) {
...
color: #de7202;
      ...
      switch (form_field) {
        ...
        case "testimonial":
          if (form_field.includes("testimonial")) {
            ...
            output_form +=
              '<textarea rows="7" type="text" id="tpro_client_testimonial" name="tpro_client_testimonial" class="' +
        ...
        case "location":
          if (form_field.includes("location")) {
            ...
            output_form +=
              '<input type="text" id="tpro_client_location" name="tpro_client_location" class="' +
              location_required +
              '" placeholder="' +
        ...
        case "rating":
          if (form_field.includes("rating")) {
            ...
            output_form +=
              '<input type="radio" name="tpro_client_rating" id="_tpro_rating_5" value="five_star"> <label for="_tpro_rating_5" title="Five Stars"><i class="fa fa-star"></i></label>';
            output_form +=
              '<input type="radio" name="tpro_client_rating" id="_tpro_rating_4" value="four_star"> <label for="_tpro_rating_4" title="Four Stars"><i class="fa fa-star"></i></label>';
            output_form +=
              '<input type="radio" name="tpro_client_rating" id="_tpro_rating_3" value="three_star"> <label for="_tpro_rating_3" title="Three Stars"><i class="fa fa-star"></i></label>';
            output_form +=
              '<input type="radio" name="tpro_client_rating" id="_tpro_rating_2" value="two_star"> <label for="_tpro_rating_2" title="Two Stars"><i class="fa fa-star"></i></label>';
            output_form +=
              '<input type="radio" name="tpro_client_rating" id="_tpro_rating_1" value="one_star"> <label for="_tpro_rating_1" title="One Stars"><i class="fa fa-star"></i></label>';
  ...
  var initTestimonialSlider = function ($) {
    ...
    $(document)
      .find(".simesy-testimonial-pro-section")
      .each(function () {
        var is_this = $(this),
        ...
        if (preloader) {
          ...
          siblings_preload.animate(
            ...
            "linear",
            function () {
              opacity: 0, siblings_preload.hide();
              siblings_preload
                .siblings(".simesy-section-title")
    ...
    $(".simesy-testimonial-pro-section.simesy_testimonial_pro_filter").each(
      function (index) {
        var filter_id = $(this).attr("id"),
          tpro_filter_config = $.parseJSON(
            $(this)
              .closest(".simesy-testimonial-pro-wrapper")
              .find(".simesy-tpro-config")
              .text()
          ),
          winDow = $(window),
          $container = $("#" + filter_id + " .simesy-tpro-isotope-items"),
          $filter = $("#" + filter_id + " .simesy-tpro-filter");
        try {
        ...
        var filterItemA = $("#" + filter_id + " .simesy-tpro-filter a");
        filterItemA.on("click", function () {
          var $this = $(this);
          $this.hasClass("active") ||
            (filterItemA.removeClass("active"), $this.addClass("active"));
        });
      }
    );
    $(document)
      .find("div[data-view-id]")
      .each(function () {
        var sliderID = $(this).attr("id"),
          testimonailData_video = $(
            "#" + sliderID + " .simesy-testimonial-pro-section"
          ).data("video"),
          testimonailData_thumb = $(
            "#" + sliderID + " .simesy-testimonial-pro-section"
          ).data("thumbnailslider"),
          stpmsnry;
        function tpro_read_more_init() {
          if (
            $(
              "#" +
                sliderID +
                " .simesy-testimonial-pro-read-more.tpro-readmore-expand-true"
            ).length > 0
          ) {
            $(
              "#" +
              ...
              var tpro_custom_read_id = $(this).attr("id"),
                tpro_read_more_config = JSON.parse(
                  $(this)
                    .closest(".simesy-testimonial-pro-wrapper")
                    .find(".sp-tpro-rm-config")
                    .text()
                );
              ...
              $(
                "#" +
                  tpro_custom_read_id +
                  " .tpro-client-testimonial .tpro-read-more:contains(" +
                  tpro_read_more_config.testimonial_read_more_text +
                  ")"
              ).trigger("click"),
                "" != tpro_custom_read_id &&
                  ($(document)
                    .find(
                      "#" + tpro_custom_read_id + " .tpro-client-testimonial"
                    )
                    .curtail({
                      limit: parseInt(
                        tpro_read_more_config.testimonial_characters_limit
                      ),
                      ellipsis:
                        tpro_read_more_config.testimonial_read_more_ellipsis,
                      toggle: !0,
                      text: [
                        tpro_read_more_config.testimonial_read_less_text,
                        tpro_read_more_config.testimonial_read_more_text,
                      ],
                    }),
                  $(
                    "#" +
                      tpro_custom_read_id +
                      " .tpro-client-testimonial .tpro-read-more"
                  ).on("click", function () {
                    $(this).parent().toggleClass("tpro-testimonial-expanded");
                    $("#" + sliderID + " .simesy_testimonial_pro_masonry")
                      .length &&
                      $(
                        "#" +
                          sliderID +
                          " .simesy_testimonial_pro_masonry .sp-tpro-items"
                      ).masonry(),
                      $(".simesy_testimonial_pro_filter").length &&
                        $(this)
                          .closest(".simesy-tpro-isotope-items, .isotope")
                          .resize();
                  }));
            });
          }
        ...
        function trpo_masonry_init() {
          var masonry = $(
            "#" + sliderID + " .simesy_testimonial_pro_masonry .sp-tpro-items"
          );
          masonry.length > 0 &&
            (masonry.masonry(),
        ...
        tpro_read_more_init(), tpro_popup_init(), trpo_masonry_init();
        var appendClass = " .simesy-tpro-items > div";
        if (
          $("#" + sliderID + " .simesy-testimonial-pro-section.infinite_scroll")
            .length > 0
        ) {
          $(window).scroll(function (e) {
            var scrollTop = $(window).scrollTop();
            $(
              ".simesy-testimonial-pro-section.infinite_scroll .simesy-tpro-pagination-area:not(.loaded)"
            ).each(function () {
              var height = $(this)
                .parents(".simesy-testimonial-pro-section")
                .find(".simesy-testimonial-pro")
                .height();
              var offset_down = $(this)
                .find(".infinite-scroll-request")
                .attr("data-down");
              if (jQuery(window).scrollTop() > offset_down) {
                if (
                  $(this).offset().top < scrollTop + height &&
                  $(this).offset().top > scrollTop + height - 300
                ) {
                  var id = $(this)
                    .parents(".simesy-testimonial-pro-wrapper")
                    .data("view-id");
                  var this_parent = $(this);
                  var shop = window.Shopify.shop;
                  var current_page = parseInt(this_parent.attr("data-cur"));
                  var total_page = this_parent.data("total");
                  if (current_page < total_page) {
                    this_parent.find(".page-load-status").show();
                    current_page++;
                    this_parent.attr("data-cur", current_page);
                    $(this).addClass("loaded");
                    $.ajax({
                      url:
                        "https://testimonial.simesy.com/api/get_more_testimonial",
                      type: "post",
                      dataType: "JSON",
                      async: false,
                      ...
                      success: function (response) {
                        ...
                        var testimonial_list =
                          response.data.shortCode.testimonials;
                        var total_page =
                          response.data.shortCode.totalTestimonialPages;
                        var html = ajaxTestiMore(
                          config,
                          id,
                          testimonial_list,
                          total_page
                        ...
                        setTimeout(function () {
                          this_parent.find(".page-load-status").hide();
                          if (
                            response.data.shortCode.config.layout[0] ==
                            "masonry"
                          ) {
                            $(
                              '.simesy-testimonial-pro-wrapper[data-view-id="' +
                                id +
                                '"]'
                            )
                              .find(".sp-tpro-items")
                          ...
                          this_parent.removeClass("loaded");
                        }, 1400);
                      },
                    });
                  }
              ...
              $(this)
                .find(".infinite-scroll-request")
                .attr("data-down", jQuery(window).scrollTop());
            });
          });
        }

        if (
          $("#" + sliderID + " .simesy-testimonial-pro-section.ajax_load_more")
            .length > 0
        ) {
          $(document).on(
            "click",
            ".simesy-tpro-pagination-area .tpro-items-load-more",
            function (e) {
              var id = $(this)
                .parents(".simesy-testimonial-pro-wrapper")
                .data("view-id");
              var this_parent = $(this).parents(".simesy-tpro-pagination-area");
              var shop = window.Shopify.shop;
              var current_page = parseInt(this_parent.attr("data-cur"));
              var total_page = this_parent.data("total");
              this_parent.find(".page-load-status").show();
        ...
        if (
          $("#" + sliderID + " .simesy-testimonial-pro-section.ajax_pagination")
            .length > 0
        ) {
          $(document).on(
            "click",
            ".simesy-tpro-pagination-area a.page-numbers",
            function (e) {
              e.preventDefault();
              e.stopPropagation();
              var id = $(this)
              ...
              var this_parent = $(this).parents(".simesy-tpro-pagination-area");
              var shop = window.Shopify.shop;
              var pagination_html = '<ul class="simesy-tpro-pagination">';
              var current_page = parseInt(this_parent.attr("data-cur"));
              var total_page = this_parent.data("total");
              var this_page = $(this).data("link");
              if (this_page == "m") {
                current_page++;
              } else if (this_page == "p") {
                current_page--;
              ...
              if (current_page > 1 && current_page != 1) {
                pagination_html +=
                  '<li><a href="javascript:void(0)" class="prev page-numbers" data-link="p"><i class="fa fa-angle-left"></i></li>';
              }
              for (var i = 1; i <= total_page; i++) {
                if (i == current_page) {
                  ...
                  pagination_html +=
                    '<li><a href="javascript:void(0)" class="page-numbers" data-link="' +
                    i +
                    '">' +
                    i +
                    "</a><li>";
              ...
              if (total_page > 1 && current_page < total_page) {
                pagination_html +=
                  '<li><a href="javascript:void(0)" class="next page-numbers" data-link="m"><i class="fa fa-angle-right"></i></a></li>';
              }
              this_parent.html(pagination_html);
              this_parent.attr("data-cur", current_page);
              $.ajax({
                url: "https://testimonial.simesy.com/api/get_more_testimonial",
                type: "post",
                ...
                success: function (response) {
                  ...
                  tpro_popup_init(), tpro_read_more_init(), trpo_masonry_init();
  ...
  var get_slider = function (config, id, testimonial_list, total_page) {
    testimonial_list = testimonial_list.splice(
      0,
      config.number_of_total_testimonials
    );
    ...
    var theme_style = config.theme_style,
      testimonial_margin =
        config.testimonial_margin != "" ? config.testimonial_margin : "20";
    ...
    var testimonial_image = config.client_image,
      ...
      image_sizes_custom_height =
        config.image_custom_size.height != ""
          ? config.image_custom_size.height
          : 120,
      image_sizes_custom_width =
    ...
    if (company_font_load) {
      testimonial_simesy_typography.push(
        config.client_designation_company_typography
      );
    }
    ...
    for (var i = 0; i < testimonial_simesy_typography.length; i++) {
      var font_weight =
        testimonial_simesy_typography[i]["font-weight"] != "normal"
          ? ":" + testimonial_simesy_typography[i]["font-weight"]
          : "";
      testimonial_simesy_font.push(
        testimonial_simesy_typography[i]["font-family"] + font_weight
      );
    }
    if (testimonial_simesy_font != "") {
      var encode_link = encodeURIComponent(
        testimonial_simesy_font.filter((font) => font).join("|")
      );
      var link = $("<link />", {
        rel: "stylesheet",
        type: "text/css",
    ...
    if (
      config.layout[0] == "masonry" ||
      config.layout[0] == "grid" ||
      config.layout[0] == "filter"
    ) {
      css += `
...
margin-bottom: ${testimonial_margin}px;
    ...
    if (config.layout[0] == "filter") {
      var filter_alignment = config.filter_alignment,
        ...
        filter_colors_active_background =
          config.filter_colors.active_background,
        filter_border_all =
          config.filter_border.all != "" ? config.filter_border.all : "2",
        filter_border_style =
          config.filter_border.style != ""
            ? config.filter_border.style
            : "solid",
        filter_border_color =
          config.filter_border.color != ""
            ? config.filter_border.color
            : "#bbbbbb",
        filter_border_color_hv =
          config.filter_border.hover_color != ""
            ? config.filter_border.hover_color
            : "#1595CE";
      css += `
...
`;
    ...
    if (testimonial_content_readmore) {
      var testimonial_content_readmore_color =
          config.testimonial_readmore_color.color,
        testimonial_content_readmore_hover =
          config.testimonial_readmore_color.hover_color,
...
margin-right:-${testimonial_margin}px; }`;
    ...
    if (section_title) {
      var section_title_type_color = config.slider_title_typography.color,
        section_title_type_font_size =
          config.slider_title_typography["font-size"],
        section_title_type_line_height =
          config.slider_title_typography["line-height"],
        section_title_type_text_transform =
          config.slider_title_typography["text-transform"],
        section_title_type_letter_spacing =
          config.slider_title_typography["letter-spacing"],
        section_title_type_text_align =
          config.slider_title_typography["text-align"],
        section_title_type_mb = config.slider_title_typography["margin-bottom"],
        section_title_type_font_weight =
          config.slider_title_typography["font-weight"];
      var font_weight =
        section_title_type_font_weight &&
        section_title_type_font_weight !== "italic" &&
        section_title_type_font_weight !== "normal"
          ? section_title_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        section_title_type_font_weight &&
        section_title_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      var font_normal =
        section_title_type_font_weight &&
...
font-style:${font_style}
      ...
      if (section_title_font_load) {
        var section_title_type_font_family =
...
font-family:${section_title_type_font_family};
    ...
    if (testimonial_image) {
      var testimonial_image_shape = config.client_image_style,
        ...
        testimonial_image_margin_two_right =
          config.client_image_margin_tow.right,
        testimonial_image_margin_two_bottom =
          config.client_image_margin_tow.bottom,
...
margin: 7px;
    ...
    if (testimonial_image && theme_style == "theme-two") {
      if (config.client_image_border_shadow[0] == "border") {
        var client_image_total_width_size =
          parseInt(config.image_custom_size.width) +
          parseInt(config.image_border.all) +
          parseInt(config.image_border.all) +
          parseInt(config.image_padding.all) +
          parseInt(config.image_padding.all);
        var client_image_total_height_size =
          parseInt(config.image_custom_size.height) +
          parseInt(config.image_border.all) +
          parseInt(config.image_border.all) +
          parseInt(config.image_padding.all) +
          parseInt(config.image_padding.all);
      ...
      var client_image_width_size_right =
        client_image_total_height_size + parseInt(`${testimonial_margin}`);
      var client_image_height_size = client_image_total_height_size / 2;

      var testimonial_inner_padding_left =
        parseInt(config.testimonial_inner_padding.left) +
        client_image_width_size;
      var testimonial_inner_padding_right =
        parseInt(config.testimonial_inner_padding.right) +
        client_image_width_size;
      var testimonial_inner_padding_top =
        parseInt(config.testimonial_inner_padding.top) +
        client_image_width_size;
      var testimonial_inner_padding_bottom =
        parseInt(config.testimonial_inner_padding.bottom) +
        client_image_width_size;
      if (config.client_image_position_two[0] == "left") {
        css += `
...
bottom: -${client_image_height_size}px;}`;
    ...
    if (testimonial_image && theme_style == "theme-six") {
      ...
      var client_image_width_size = client_image_total_width_size / 2;
      var client_image_width_size_right =
        client_image_width_size + parseInt(`${testimonial_margin}`);
      var client_image_height_size = client_image_total_height_size / 2;
...
bottom: -${client_image_height_size}px;}`;
    ...
    if (testimonial_image && theme_style == "theme-seven") {
      ...
      var testimonial_inner_padding_top =
        parseInt(config.testimonial_inner_padding.top) +
        parseInt(client_image_height_size_bottom);
...
`;
    ...
    if (testimonial_title) {
      var testimonial_title_type_color =
          config.testimonial_title_typography.color,
        testimonial_title_type_font_size =
          config.testimonial_title_typography["font-size"],
        testimonial_title_type_line_height =
          config.testimonial_title_typography["line-height"],
        testimonial_title_type_text_transform =
          config.testimonial_title_typography["text-transform"],
        testimonial_title_type_letter_spacing =
          config.testimonial_title_typography["letter-spacing"],
        testimonial_title_type_text_align =
          config.testimonial_title_typography["text-align"],
        testimonial_title_type_mt =
          config.testimonial_title_typography["margin-top"],
        testimonial_title_type_mr =
          config.testimonial_title_typography["margin-right"],
        testimonial_title_type_mb =
          config.testimonial_title_typography["margin-bottom"],
        testimonial_title_type_ml =
          config.testimonial_title_typography["margin-left"],
        testimonial_title_type_font_weight =
          config.testimonial_title_typography["font-weight"];
      var font_normal =
        testimonial_title_type_font_weight &&
        testimonial_title_type_font_weight !== "italic" &&
        testimonial_title_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        testimonial_title_type_font_weight &&
        testimonial_title_type_font_weight !== "italic" &&
        testimonial_title_type_font_weight !== "normal"
          ? testimonial_title_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        testimonial_title_type_font_weight &&
        testimonial_title_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
.simesy-tpro-modal-testimonial-${id}.simesy-tpro-modal-testimonial .tpro-testimonial-title{
margin: ${testimonial_title_type_mt}px ${testimonial_title_type_mr}px ${testimonial_title_type_mb}px ${testimonial_title_type_ml}px;
}
...
`;
      if (testimonial_title_font_load) {
        var testimonial_title_type_font_family =
          config.testimonial_title_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-testimonial-title .sp-tpro-testimonial-title{
...
`;
    ...
    if (testimonial_content) {
      var testimonial_content_type_color =
          config.testimonial_text_typography.color,
        testimonial_content_type_font_size =
          config.testimonial_text_typography["font-size"],
        testimonial_content_type_line_height =
          config.testimonial_text_typography["line-height"],
        testimonial_content_type_text_transform =
          config.testimonial_text_typography["text-transform"],
        testimonial_content_type_letter_spacing =
          config.testimonial_text_typography["letter-spacing"],
        testimonial_content_type_text_align =
          config.testimonial_text_typography["text-align"],
        testimonial_title_type_mt =
          config.testimonial_text_typography["margin-top"],
        testimonial_title_type_mr =
          config.testimonial_text_typography["margin-right"],
        testimonial_title_type_mb =
          config.testimonial_text_typography["margin-bottom"],
        testimonial_title_type_ml =
          config.testimonial_text_typography["margin-left"],
        testimonial_content_type_font_weight =
          config.testimonial_text_typography["font-weight"];
      var font_normal =
        testimonial_content_type_font_weight &&
        testimonial_content_type_font_weight !== "italic" &&
        testimonial_content_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        testimonial_content_type_font_weight &&
        testimonial_content_type_font_weight !== "italic" &&
        testimonial_content_type_font_weight !== "normal"
          ? testimonial_content_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        testimonial_content_type_font_weight &&
        testimonial_content_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (testimonial_content_font_load) {
        var testimonial_content_type_font_family =
          config.testimonial_text_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-testimonial{
...
`;
    ...
    if (testimonial_fullname) {
      var fullname_type_color = config.client_name_typography.color,
        ...
        fullname_type_line_height =
          config.client_name_typography["line-height"],
        fullname_type_text_transform =
          config.client_name_typography["text-transform"],
        fullname_type_letter_spacing =
          config.client_name_typography["letter-spacing"],
        ...
        fullname_type_font_weight =
          config.client_name_typography["font-weight"];
      var font_normal =
        fullname_type_font_weight &&
        fullname_type_font_weight !== "italic" &&
        fullname_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        fullname_type_font_weight &&
        fullname_type_font_weight !== "italic" &&
        fullname_type_font_weight !== "normal"
          ? fullname_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        fullname_type_font_weight &&
        fullname_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (fullname_font_load) {
        var fullname_type_font_family =
          config.client_name_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-name{
...
`;
    ...
    if (testimonial_client_rating) {
      var testimonial_client_rating_color =
          config.testimonial_client_rating_color,
        testimonial_client_rating_alignment =
          config.testimonial_client_rating_alignment,
        testimonial_client_rating_margin_top =
          config.testimonial_client_rating_margin.top != ""
            ? config.testimonial_client_rating_margin.top
            : "0",
        testimonial_client_rating_margin_right =
          config.testimonial_client_rating_margin.right != ""
            ? config.testimonial_client_rating_margin.right
            : "0",
        testimonial_client_rating_margin_bottom =
          config.testimonial_client_rating_margin.bottom != ""
            ? config.testimonial_client_rating_margin.bottom
            : "0",
        testimonial_client_rating_margin_left =
          config.testimonial_client_rating_margin.left != ""
            ? config.testimonial_client_rating_margin.left
            : "0";
      css += `
...
`;
    ...
    if (client_designation || client_company_name) {
      var company_type_color =
          config.client_designation_company_typography.color,
        company_type_font_size =
          config.client_designation_company_typography["font-size"],
        company_type_line_height =
          config.client_designation_company_typography["line-height"],
        company_type_text_transform =
          config.client_designation_company_typography["text-transform"],
        company_type_letter_spacing =
          config.client_designation_company_typography["letter-spacing"],
        company_type_text_align =
          config.client_designation_company_typography["text-align"],
        company_type_mt =
          config.client_designation_company_typography["margin-top"],
        company_type_mr =
          config.client_designation_company_typography["margin-right"],
        company_type_mb =
          config.client_designation_company_typography["margin-bottom"],
        company_type_ml =
          config.client_designation_company_typography["margin-left"],
        company_type_font_weight =
          config.client_designation_company_typography["font-weight"];
      var font_normal =
        company_type_font_weight &&
        company_type_font_weight !== "italic" &&
        company_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        company_type_font_weight &&
        company_type_font_weight !== "italic" &&
        company_type_font_weight !== "normal"
          ? company_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        company_type_font_weight &&
        company_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      ...
      if (company_font_load) {
        var company_type_font_family =
          config.client_designation_company_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-designation-company{
...
`;
    ...
    if (testimonial_client_location) {
      var location_type_color = config.client_location_typography.color,
        location_type_font_size =
          config.client_location_typography["font-size"],
        location_type_line_height =
          config.client_location_typography["line-height"],
        location_type_text_transform =
          config.client_location_typography["text-transform"],
        location_type_letter_spacing =
          config.client_location_typography["letter-spacing"],
        location_type_text_align =
          config.client_location_typography["text-align"],
        ...
        location_type_font_weight =
          config.client_location_typography["font-weight"];
      var font_normal =
        location_type_font_weight &&
        location_type_font_weight !== "italic" &&
        location_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        location_type_font_weight &&
        location_type_font_weight !== "italic" &&
        location_type_font_weight !== "normal"
          ? location_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        location_type_font_weight &&
        location_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (location_font_load) {
        var location_type_font_family =
          config.client_location_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-location{
...
`;
    ...
    if (testimonial_client_phone) {
      var phone_type_color = config.client_phone_typography.color,
        ...
        phone_type_text_transform =
          config.client_phone_typography["text-transform"],
        phone_type_letter_spacing =
          config.client_phone_typography["letter-spacing"],
      ...
      var font_normal =
        phone_type_font_weight &&
        phone_type_font_weight !== "italic" &&
        phone_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        phone_type_font_weight &&
        phone_type_font_weight !== "italic" &&
        phone_type_font_weight !== "normal"
          ? phone_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        phone_type_font_weight && phone_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (phone_font_load) {
        var phone_type_font_family =
          config.client_phone_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-phone{
...
`;
    ...
    if (testimonial_client_email) {
      var email_type_color = config.client_email_typography.color,
        ...
        email_type_text_transform =
          config.client_email_typography["text-transform"],
        email_type_letter_spacing =
          config.client_email_typography["letter-spacing"],
      ...
      var font_normal =
        email_type_font_weight &&
        email_type_font_weight !== "italic" &&
        email_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        email_type_font_weight &&
        email_type_font_weight !== "italic" &&
        email_type_font_weight !== "normal"
          ? email_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        email_type_font_weight && email_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (email_font_load) {
        var email_type_font_family =
          config.client_email_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-email{
...
`;
    ...
    if (testimonial_client_date) {
      var date_type_color = config.testimonial_date_typography.color,
        ...
        date_type_line_height =
          config.testimonial_date_typography["line-height"],
        date_type_text_transform =
          config.testimonial_date_typography["text-transform"],
        date_type_letter_spacing =
          config.testimonial_date_typography["letter-spacing"],
        ...
        date_type_font_weight =
          config.testimonial_date_typography["font-weight"];
      var font_normal =
        date_type_font_weight &&
        date_type_font_weight !== "italic" &&
        date_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        date_type_font_weight &&
        date_type_font_weight !== "italic" &&
        date_type_font_weight !== "normal"
          ? date_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        date_type_font_weight && date_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (date_font_load) {
        var date_type_font_family =
          config.testimonial_date_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-date{
...
`;
    ...
    if (testimonial_client_website) {
      var website_type_color = config.client_website_typography.color,
        ...
        website_type_line_height =
          config.client_website_typography["line-height"],
        website_type_text_transform =
          config.client_website_typography["text-transform"],
        website_type_letter_spacing =
          config.client_website_typography["letter-spacing"],
        website_type_text_align =
          config.client_website_typography["text-align"],
        ...
        website_type_font_weight =
          config.client_website_typography["font-weight"];

      var font_normal =
        website_type_font_weight &&
        website_type_font_weight !== "italic" &&
        website_type_font_weight === "normal"
          ? "normal"
          : "";
      var font_weight =
        website_type_font_weight &&
        website_type_font_weight !== "italic" &&
        website_type_font_weight !== "normal"
          ? website_type_font_weight.replace("italic", "")
          : font_normal;
      var font_style =
        website_type_font_weight &&
        website_type_font_weight.substr(-6) === "italic"
          ? "italic"
          : "";
      css += `
...
`;
      if (website_font_load) {
        var website_type_font_family =
          config.client_website_typography["font-family"];
        css += `
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .tpro-client-website{
...
`;
    ...
    if (nav_desktop == "true" || nav_mobile == "true") {
      var nav_color =
          config.navigation_color.color != ""
            ? config.navigation_color.color
            : "",
        nav_size =
          config.navigation_icon_size != ""
            ? config.navigation_icon_size
            : "20",
        nav_bg =
          config.navigation_color.background != ""
            ? config.navigation_color.background
            : "",
        nav_border =
          config.navigation_color.border != ""
            ? config.navigation_color.border
            : "",
        nav_color_hover =
          config.navigation_color.hover_color != ""
            ? config.navigation_color.hover_color
            : "",
        nav_border_hover =
          config.navigation_color.hover_border != ""
            ? config.navigation_color.hover_border
            : "",
        nav_bg_hover =
          config.navigation_color.hover_background != ""
            ? config.navigation_color.hover_background
            : "",
        line_height = 32 - parseInt(config.navigation_border.all) * 2,
        nav_border_all =
          config.navigation_border.all != ""
            ? config.navigation_border.all
            : "",
        nav_border_style = config.navigation_border.style,
        nav_border_color =
          config.navigation_border.color != ""
            ? config.navigation_border.color
            : "",
        nav_border_hover_color =
          config.navigation_border.hover_color != ""
            ? config.navigation_border.hover_color
            : "",
        nav_border_radius =
          config.navigation_border_radius.all != ""
            ? config.navigation_border_radius.all
            : "0",
        nav_border_unit =
          config.navigation_border_radius.unit != ""
            ? config.navigation_border_radius.unit
            : "px";
      css += `
...
`;
      if (
        (layout_present == "slider" && nav_desktop == "true") ||
        (layout_present == "slider" && nav_all == "true") ||
        (layout_present == "slider" && nav_mobile == "true")
      ) {
        if (section_title) {
          if (
            navigation_position == "top_right" ||
            navigation_position == "top_center" ||
            navigation_position == "top_left"
          ) {
            css += `
...
padding-top: 46px;
        ...
        if (
          navigation_position == "bottom_right" ||
          navigation_position == "bottom_center" ||
          navigation_position == "bottom_left"
        ) {
          css += `
...
#sp-testimonial-pro-wrapper-${id}.sp_tpro_nav_position_top_right .slick-prev{
...
`;
        ...
        if (
          ...
          navigation_position == "vertical_center_inner"
        ) {
          css += `
...
`;
    ...
    if (pagi_desktop == "true" || pagi_mobile == "true") {
      var pagination_color =
          config.pagination_colors.color != ""
            ? config.pagination_colors.color
            : "",
        pagination_active_color =
          config.pagination_colors.active_background != ""
            ? config.pagination_colors.active_background
            : "",
...
`;
    ...
    if (
      layout_present == "grid" ||
      layout_present == "masonry" ||
      layout_present == "list"
    ) {
      if (config.grid_pagination) {
        var grid_pagination_colors_color =
          config.grid_pagination_colors.color != ""
            ? config.grid_pagination_colors.color
            : "";
        var grid_pagination_colors_background =
          config.grid_pagination_colors.background != ""
            ? config.grid_pagination_colors.background
            : "";
        var grid_pagination_colors_hover_color =
          config.grid_pagination_colors.hover_color != ""
            ? config.grid_pagination_colors.hover_color
            : "";
        var grid_pagination_colors_hover_background =
          config.grid_pagination_colors.hover_background != ""
            ? config.grid_pagination_colors.hover_background
            : "";

        var grid_pagination_border_all =
          config.grid_pagination_border.all != ""
            ? config.grid_pagination_border.all
            : "";
        var grid_pagination_border_style = config.grid_pagination_border.style;
        var grid_pagination_border_color =
          config.grid_pagination_border.color != ""
            ? config.grid_pagination_border.color
            : "";
        var grid_pagination_border_hover_color =
          config.grid_pagination_border.hover_color != ""
            ? config.grid_pagination_border.hover_color
            : "";
        css += `
...
#sp-testimonial-pro-wrapper-${id} .simesy-testimonial-pro-section .tpro-social-profile,
.simesy-tpro-modal-testimonial-${id}.simesy-tpro-modal-testimonial .tpro-social-profile{
...
`;
    ...
    var testimonial_border_all = config.testimonial_border.all,
      ...
      testimonial_inner_padding_bottom =
        config.testimonial_inner_padding.bottom,
...
border: ${testimonial_border_color};
...
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .simesy-testimonial-pro .tpro-testimonial-content-area:before {
border-color: transparent;
border-top-color: ${testimonial_info_border_color};
...
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .simesy-testimonial-pro .tpro-testimonial-content-area:after {
border-color: transparent;
border-left-color: ${testimonial_bg_three};
border-width: 13px 0 13px 17px;
}
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .simesy-testimonial-pro .tpro-testimonial-content-area:before {
border-color: transparent;
border-left-color: ${testimonial_border_color};
...
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .simesy-testimonial-pro .tpro-testimonial-content-area:after {
border-color: transparent;
border-right-color: ${testimonial_bg_three};
border-width: 13px 17px 13px 0;
}
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .simesy-testimonial-pro .tpro-testimonial-content-area:before {
border-color: transparent;
border-right-color: ${testimonial_border_color};
...
#simesy-testimonial-pro-${id}.simesy-testimonial-pro-section .simesy-testimonial-pro .tpro-testimonial-content-area:before {
border-color: transparent;
border-top-color: ${testimonial_border_color};
border-width: ${tpro_border_height}px ${tpro_border_width}px 0 ${tpro_border_width}px;
margin-right: -${testimonial_border_all}px;
}
`;
...
`;
    ...
    if (theme_style == "theme-ten") {
      if (config.client_image_border_shadow[0] == "border") {
        var client_image_total_height_size =
          parseInt(image_sizes_custom_height) +
          parseInt(config.image_border.all) +
          parseInt(config.image_border.all) +
          parseInt(config.image_padding.all) +
          parseInt(config.image_padding.all);
      ...
      var client_image_height_size =
        parseInt(client_image_height_size_two) +
        parseInt(config.testimonial_inner_padding.top);
      css += `
...
`;
    ...
    switch (config.filter_style[0]) {
      case "even":
        var filter_mode = '{"filter_mode":"fitRows"}';
        break;
      case "masonry":
        var filter_mode = '{"filter_mode":"masonry"}';
        break;
    }
    var html = "",
      html_thumb = "",
    ...
    var carousel_pause_on_hover = config.slider_pause_on_hover,
      ...
      columns_1 =
        config.columns.large_desktop != "" ? config.columns.large_desktop : "1",
      ...
      carousel_scroll_speed =
        config.slider_scroll_speed != "" ? config.slider_scroll_speed : "600",
      carousel_auto_play_speed =
        config.slider_auto_play_speed != ""
          ? config.slider_auto_play_speed
          : "3000",
      slides_to_scroll_1 =
        config.slide_to_scroll.large_desktop != ""
          ? config.slide_to_scroll.large_desktop
          : "1",
      slides_to_scroll_2 =
        config.slide_to_scroll.desktop != ""
          ? config.slide_to_scroll.desktop
          : "1",
      slides_to_scroll_3 =
        config.slide_to_scroll.laptop != ""
          ? config.slide_to_scroll.laptop
          : "1",
      slides_to_scroll_4 =
        config.slide_to_scroll.tablet != ""
          ? config.slide_to_scroll.tablet
          : "1",
      slides_to_scroll_5 =
        config.slide_to_scroll.mobile != ""
          ? config.slide_to_scroll.mobile
          : "1",
      slider_row_1 =
        config.slider_row.large_desktop != ""
          ? config.slider_row.large_desktop
          : "1",
      slider_row_2 =
        config.slider_row.desktop != "" ? config.slider_row.desktop : "1",
      slider_row_3 =
        config.slider_row.laptop != "" ? config.slider_row.laptop : "1",
      slider_row_4 =
        config.slider_row.tablet != "" ? config.slider_row.tablet : "1",
      slider_row_5 =
        config.slider_row.mobile != "" ? config.slider_row.mobile : "1",
    ...
    if (layout_present == "slider" && config.thumbnail_slider == false) {
      class_layout +=
        "simesy-testimonial-pro-section  tpro-layout-slider-" +
        carousel_ticker_mode +
        " simesy-testimonial-pro-read-more tpro-readmore-" +
        config.testimonial_read_more_link_action[0] +
        "-" +
        config.testimonial_read_more +
        " tpro-style-" +
        theme_style +
        "";
      ...
      if (carousel_ticker_mode == "standard") {
        slider_data +=
          ' data-mode="normal" data-arrowicon="' +
        ...
        slider_data +=
          ' data-mode="ticker" data-slick=\'{"pauseOnHover": ' +
          carousel_pause_on_hover +
          ', "slidesToShow": ' +
          columns_1 +
          ', "speed": ' +
    ...
    if (layout_present == "grid") {
      class_layout +=
        ...
        config.tp_pagination_type[0] +
        " tpro-layout-grid-" +
        config.slider_mode[0] +
        " simesy-testimonial-pro-read-more tpro-readmore-" +
        config.testimonial_read_more_link_action[0] +
        "-" +
        config.testimonial_read_more +
    ...
    if (layout_present == "masonry") {
      class_layout +=
        ...
        "-" +
        config.testimonial_read_more +
        " simesy_testimonial_pro_masonry tpro-style-" +
        theme_style +
        "";
    }
    ...
    if (layout_present == "filter") {
      class_layout +=
        "simesy-testimonial-pro-section tpro-layout-list-" +
        config.slider_mode[0] +
        " simesy-testimonial-pro-read-more tpro-readmore-" +
        config.testimonial_read_more_link_action[0] +
        "-" +
        config.testimonial_read_more +
        " simesy_testimonial_pro_filter tpro-style-" +
        theme_style +
        "";
      html += '<div class="simesy-tpro-config">' + filter_mode + "</div>";
    }

    var class_preload = pre_loader ? "preloader" : "";
    if (config.section_title) {
      html +=
        '<h2 class="simesy-section-title ' +
        class_preload +
        '">' +
        config.title +
        "</h2>";
    ...
    if (pre_loader) {
      html +=
        ...
        id +
        '" style=""><img src="https://cdn.shopify.com/s/files/1/0553/9830/1811/files/preloader.gif?v=1639626026"/></div>';
    }
...
breakpoint: 1280,
settings: {
slidesToShow: ${columns_2}
}
},
{
breakpoint: 980,
settings: {
slidesToShow: ${columns_3}
}
},
{
breakpoint: 736,
settings: {
slidesToShow: ${columns_4}
}
},
{
breakpoint: 480,
settings: {
slidesToShow: ${columns_5},
dots: false,
arrows: false,
autoplay: false,
}
      ...
      html_thumb +=
        '<div id="simesy-testimonial-pro-' +
        id +
        '" dir="' +
        rtl_mode_true +
        '" data-thumbnailSlider="' +
        thumbnail_slider +
        '" class="simesy-testimonial-pro-section simesy-testimonial-pro-section-thumb">';
      html_info +=
        '<div id="simesy-testimonial-pro-' +
        id +
        '" dir="' +
        ...
        '" data-preloader=' +
        pre_loader +
        ' class="simesy-testimonial-pro-section simesy-testimonial-pro-section-content ' +
        config.tp_pagination_type[0] +
        " tpro-layout-list-" +
        config.slider_mode[0] +
        " simesy-testimonial-pro-read-more tpro-readmore-" +
    ...
    $("div[data-view-id='" + id + "']").addClass(
      "sp_tpro_nav_position_" +
        navigation_position +
        " simesy_" +
        config.theme_style +
        ""
    ...
    if (layout_present == "filter") {
      html_theme += '<div class="simesy-tpro-isotope-items isotope">';
    }
    var img_thumb = "";
    var html_popup = "";
    // Pagination
    ...
    $.each(testimonial_list, function (index, item_testi) {
      if (layout_present == "slider" && config.thumbnail_slider) {
        ...
        if (item_testi.config.image_url != "") {
          html_thumb +=
            '<div class="tpro-client-image tpro-image-style-' +
            config.client_image_style +
            '">';
          html_thumb +=
            '<img src="' +
            imgURL(
      ...
      if (
        config.testimonial_read_more &&
        config.testimonial_read_more_link_action[0] == "popup"
      ) {
        html_popup +=
          '<div class="remodal simesy-tpro-modal-testimonial-' +
          id +
          ' simesy-tpro-modal-testimonial" data-remodal-id="simesy-tpro-testimonial-id-' +
          id +
          "-" +
          index +
          '">';
        ...
        if (config.client_image && item_testi.config.image_url != "") {
          var image_sizes_custom_height =
              config.image_custom_size.height != ""
                ? config.image_custom_size.height
                : 120,
          ...
          html_popup +=
            ...
            config.client_image_style +
            " tpro-image-position-" +
            config.client_image_position_two[0] +
            '">';
        ...
        if (config.testimonial_title && item_testi.config.title != "") {
          ...
          html_popup +=
            "<" +
            config.testimonial_title_tag +
            ' class="sp-tpro-testimonial-title">' +
        ...
        if (config.testimonial_text && text_des != "") {
          ...
          html_popup +=
            '<div class="tpro-testimonial-text">' + des_modal + "</div>";
        ...
        if (config.testimonial_client_name && item_testi.config.name != "") {
          html_popup +=
            "<" +
            config.testimonial_client_name_tag +
            ' class="tpro-client-name">' +
        ...
        if (config.testimonial_client_rating) {
          html_popup +=
            ...
            render_rate(item_testi.config.rating, "fa fa-star") +
            "</div>";
        }
        if (config.client_designation && item_testi.config.designation != "") {
          if (config.identity_linking_website) {
            html_popup +=
              '<div class="tpro-client-designation-company"><a href="' +
              item_testi.config.website +
              '" target="' +
              config.website_link_target[0] +
              '" >' +
              item_testi.config.designation +
              "</a></div>";
          } else {
            html_popup +=
              '<div class="tpro-client-designation-company">' +
              item_testi.config.designation +
              "</div>";
          }
        }
        if (
          config.testimonial_client_location &&
          item_testi.config.location != ""
        ) {
          html_popup +=
        ...
        if (config.testimonial_client_phone && item_testi.config.phone != "") {
          html_popup +=
            ...
            item_testi.config.phone +
            "</div>";
        }
        if (config.testimonial_client_email && item_testi.config.email != "") {
          html_popup +=
            '<div class="tpro-client-email">' +
            item_testi.config.email +
            "</div>";
        }
        if (config.testimonial_client_date && item_testi.createdAt != "") {
          html_popup +=
            '<div class="tpro-client-date">' +
            dateFormat(
              item_testi.createdAt,
              config.testimonial_client_date_format
            ) +
            "</div>";
        }
        if (
          config.testimonial_client_website &&
          item_testi.config.website != ""
        ) {
          if (config.identity_linking_website) {
            html_popup +=
              '<div class="tpro-client-website"><a href="' +
              item_testi.config.website +
              '" target="' +
              config.website_link_target[0] +
              '">' +
    ...
    if (config.grid_pagination) {
      if (
        (layout_present == "grid" && config.grid_pagination) ||
        (layout_present == "masonry" && config.grid_pagination) ||
        (layout_present == "list" && config.grid_pagination)
      ) {
        var hide_pagi =
          config.tp_pagination_type == "ajax_load_more" ||
          config.tp_pagination_type == "infinite_scroll"
            ? 'style="display:none"'
            : "";
        var pagination_html =
          '<ul class="simesy-tpro-pagination" ' + hide_pagi + ">";
        var current_page = 1;
        html_theme +=
          '<div class="tpro-col-xl-1 simesy-tpro-pagination-area" data-total="' +
          total_page +
          '" data-cur="' +
          current_page +
          '">';
        ...
        pagination_html += "</ul>";
        html_theme += pagination_html;

        if (
          "ajax_load_more" == config.tp_pagination_type ||
          "infinite_scroll" == config.tp_pagination_type
        ) {
          html_theme += '<div class="page-load-status">';
          html_theme +=
            '<div class="loader-ellips infinite-scroll-request" data-down="0">';
          html_theme +=
            '<p><span class="loader-ellips__dot"></span><span class="loader-ellips__dot"></span><span class="loader-ellips__dot"></span><span class="loader-ellips__dot"></span></p>';
          html_theme += "</div>";
          html_theme +=
            '<p class="infinite-scroll-last" style="display:none">End of content</p><p class="infinite-scroll-error" style="display:none">No more testimonials to load</p>';
          html_theme += "</div>";
        }
        if ("ajax_load_more" == config.tp_pagination_type) {
          html_theme +=
            '<div class="tpro-items-load-more"><span>' +
    ...
    if (layout_present == "slider" && config.thumbnail_slider) {
      ...
      $("#sp-testimonial-pro-wrapper-" + id + "").append(
        script_thumb + html_thumb + html_info
      );
    } else {
  ...
  function ajaxTestiMore(config, id, testimonial_list) {
    ...
    $.each(testimonial_list, function (index, item_testi) {
      switch (config.theme_style) {
        case "theme-one":
          html_load += html_theme_one(item_testi, config, id, index);
          break;
        case "theme-two":
          html_load += html_theme_two(item_testi, config, id, index);
          break;
        case "theme-three":
          html_load += html_theme_three(item_testi, config, id, index);
          break;
        case "theme-four":
          html_load += html_theme_four(item_testi, config, id, index);
          break;
        case "theme-five":
          html_load += html_theme_five(item_testi, config, id, index);
          break;
        case "theme-six":
          html_load += html_theme_six(item_testi, config, id, index);
          break;
        case "theme-seven":
          html_load += html_theme_seven(item_testi, config, id, index);
          break;
        case "theme-eight":
          html_load += html_theme_eight(item_testi, config, id, index);
          break;
        case "theme-nine":
          html_load += html_theme_nine(item_testi, config, id, index);
          break;
        case "theme-ten":
          html_load += html_theme_ten(item_testi, config, id, index);
          break;
        default:
      }
    });
  ...
  function html_theme_one(testi, config, id, index) {
    ...
    if (config.layout[0] == "grid") {
      html_fun +=
        '<div class="simesy-testimonial-pro-item tpro-col-xl-' +
        config.columns.large_desktop +
        " tpro-col-lg-" +
        config.columns.desktop +
        " tpro-col-md-" +
        config.columns.laptop +
        " tpro-col-sm-" +
        config.columns.tablet +
        " tpro-col-xs-" +
        config.columns.mobile +
        ' post-127 spt_testimonial type-spt_testimonial status-publish hentry ">';
    }
    if (config.layout[0] == "masonry") {
      html_fun +=
        ...
        " tpro-col-xs-" +
        config.columns.mobile +
        ' post-127 spt_testimonial type-spt_testimonial status-publish hentry masonry-brick">';
    }
    if (config.layout[0] == "list") {
      html_fun += '<div class="simesy-testimonial-pro-item">';
    }
    if (config.layout[0] == "filter") {
      html_fun +=
        ...
        " tpro-col-xs-" +
        config.columns.mobile +
        ' post-127 spt_testimonial type-spt_testimonial status-publish isotope-item">';
    }
    html_fun += '<div class="simesy-testimonial-pro">';
    if (
      config.client_image &&
      config.thumbnail_slider == false &&
      testi.config.image_url != ""
    ) {
      var image_sizes_custom_height =
          config.image_custom_size.height != ""
            ? config.image_custom_size.height
      ...
      if (config.video_icon && testi.config.video_url != "") {
        html_fun +=
          '<a href="' + testi.config.video_url + '" class="sp-tpro-video">';
        html_fun +=
          '<img src="' +
          imgURL(
            testi.config.image_url,
            config.image_sizes,
            "w_" + image_sizes_custom_width + ",h_" + image_sizes_custom_height
          ) +
          '" class="tpro-grayscale-' +
          config.image_grayscale +
          '">';
    ...
    if (config.testimonial_text && text_des != "") {
      ...
      html_fun +=
        '<div class="tpro-testimonial-text">' +
        test_des(testi.config.content, config) +
        "</div>";
      if (config.testimonial_read_more) {
        if (config.testimonial_read_more_link_action[0] == "expand") {
          html_fun +=
            '<a href="#" class="tpro-read-more">' +
            config.testimonial_read_more_text +
            "</a>";
        } else {
          html_fun +=
            '<a href="#" data-remodal-target="simesy-tpro-testimonial-id-' +
            id +
            "-" +
            index +
            '" class="tpro-read-more">' +
            config.testimonial_read_more_text +
            "</a>";
        }
      }
    ...
    if (config.testimonial_client_rating) {
      html_fun +=
        '<div class="tpro-client-rating">' +
        render_rate(testi.config.rating, config.tpro_star_icon[0]) +
        "</div>";
    }
    if (config.client_designation && testi.config.designation != "") {
      if (config.identity_linking_website) {
        html_fun +=
          '<div class="tpro-client-designation-company"><a href="' +
          testi.config.website +
          '" target="' +
          config.website_link_target[0] +
          '">' +
          testi.config.designation +
          "</a></div>";
      } else {
        html_fun +=
          '<div class="tpro-client-designation-company">' +
    ...
    if (config.testimonial_client_location && testi.config.location != "") {
      html_fun +=
        '<div class="tpro-client-location">' + testi.config.location + "</div>";
    }
    if (config.testimonial_client_phone && testi.config.phone != "") {
      html_fun +=
        '<div class="tpro-client-phone">' + testi.config.phone + "</div>";
    }
    if (config.testimonial_client_email && testi.config.email != "") {
      html_fun +=
        '<div class="tpro-client-email">' + testi.config.email + "</div>";
    }
    if (config.testimonial_client_date && testi.createdAt != "") {
      html_fun +=
        '<div class="tpro-client-date">' +
        dateFormat(testi.createdAt, config.testimonial_client_date_format) +
        "</div>";
    }
    if (config.testimonial_client_website && testi.config.website != "") {
      if (config.identity_linking_website) {
        ...
        html_fun +=
          '<div class="tpro-client-website">' + testi.config.website + "</div>";
      }
    }
    if (config.social_profile) {
      ...
      $.each(testi.config.social_profiles, function (i, social) {
        html_fun +=
          ...
          social.social_url +
          '" class="tpro-' +
          social.social_name.toLowerCase() +
          '" target="_blank"><i class="fa fa-' +
          social.social_name.toLowerCase() +
          '"></i></a>';
      });
  ...
  function html_theme_two(testi, config, id, index) {
    ...
    html_fun += '<div class="simesy-testimonial-pro">';
    if (config.client_image && testi.config.image_url != "") {
      var image_sizes_custom_height =
          config.image_custom_size.height != ""
            ? config.image_custom_size.height
            : 120,
  ...
  function html_theme_nine(testi, config, id, index) {
    ...
    html_fun += '<div class="simesy-testimonial-pro">';
    if (
      config.testimonial_info_position_two[0] == "top_left" ||
      config.testimonial_info_position_two[0] == "top_right"
    ) {
      html_fun += '<div class="tpro-testimonial-meta-area">';
  ...
  function html_theme_ten(testi, config, id, index) {
    ...
    if (config.layout[0] == "grid") {
      html_fun +=
        '<div class="sp-testimonial-pro-item tpro-col-xl-' +
        config.columns.large_desktop +
        " tpro-col-lg-" +
        config.columns.desktop +
        " tpro-col-md-" +
    ...
    html_fun +=
      '<div class="simesy-testimonial-pro"><div class="simesy-tpro-top-background"></div>';
    if (config.client_image && testi.config.image_url != "") {
      var image_sizes_custom_height =
          config.image_custom_size.height != ""
            ? config.image_custom_size.height
